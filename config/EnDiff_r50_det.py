...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint= './work_dirs/EnDiff_r50_diff/epoch_10.pth'
    ),
    diff_cfg=dict(
        type='EnDiff',
...
train_ann = '/media/HDD0/XCX/synthetic_dataset/annotations/split_results/part2_train.json'
test_ann = '/media/HDD0/XCX/synthetic_dataset/annotations/split_results/part2_test.json'
