...
train_ann = '/media/HDD0/XCX/synthetic_dataset/annotations/split_results/part1_train.json'
test_ann = '/media/HDD0/XCX/synthetic_dataset/annotations/split_results/part1_val.json'
